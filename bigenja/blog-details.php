...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Aug 2019 23:13:42 GMT -->
<head>
                        ...
                        <div class="single-blog-post"><!-- single blog post -->
                            ...
                            <div class="details-container"><!-- details contaienr -->
                                ...
                                <div class="post-body"><!-- post body -->
                                    <h3 class="title"><?php echo $blog['head']?></h3>
        ...
        ?>  <div class="single-blog-page-separator"></div>
                                <div class="comments-form-area"><!-- comments form area -->
                                    ...
                                    <div class="comment-form-wrapper"><!-- comment form wrapper -->
                                        <form action="function/com_add.php"  method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-element margin-bottom-15">
                                                <div class="has-icon textarea">
                                                    <textarea name="content" rows="20" cols="8" placeholder="Type your comments...." class="input-field borderd textarea"></textarea>
                                                    <div class="the-icon">
                                    ...
                                    <div class="comment-form-wrapper"><!-- comment form wrapper -->
                                        <form action="function/com_add.php"  method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-element margin-bottom-20">
                                                <div class="has-icon ">
                                                   <input name="user_name" type="text" class="input-field borderd" placeholder="Type your name....">
                                                    <div class="the-icon">
                                            ...
                                            <div class="form-element margin-bottom-20">
                                                <div class="has-icon ">
                                                   <input name="email" type="email" class="input-field borderd" placeholder="Type your email....">
                                                    <div class="the-icon">
...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Aug 2019 23:13:48 GMT -->
</html>