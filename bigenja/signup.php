...
<!-- Mirrored from idealbrothers.thesoftking.com/html/bigenza/bigenja/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Aug 2019 23:12:46 GMT -->
<head>
                        ...
                        <div class="col-lg-6">
                            <div class="right-contnet-area">
                                ...
                                <div class="bottom-content">
                                    <form action="function/signup.php"  method="post" enctype="multipart/form-data" class="login-form">
